...
namespace ApkResourceParser
{
    ...
    public class ResourceValue
    {
        ...
        public override string ToString()
        {
            ...
            switch (valueType)
            {
                case ResourceValue.Type.NULL:
                    return data() == 0 ? "null" : "empty";
                case ResourceValue.Type.REFERENCE:
                    return "ref(" + dataHexString() + ")";
                case ResourceValue.Type.ATTRIBUTE:
                    return "attr(" + dataHexString() + ")";
                case ResourceValue.Type.STRING:
                    return "string(" + dataHexString() + ")";
                case ResourceValue.Type.FLOAT:
                    return "float(" + data() + ")";
                case ResourceValue.Type.DIMENSION:
                    return "dimen(" + data() + ")";
                case ResourceValue.Type.FRACTION:
                    return "frac(" + data() + ")";
                case ResourceValue.Type.DYNAMIC_REFERENCE:
                    return "dynref(" + dataHexString() + ")";
                case ResourceValue.Type.DYNAMIC_ATTRIBUTE:
                    return "dynattr(" + dataHexString() + ")";
                case ResourceValue.Type.INT_DEC:
                    return "dec(" + data() + ")";
                case ResourceValue.Type.INT_HEX:
                    return "hex(" + dataHexString() + ")";
                case ResourceValue.Type.INT_BOOLEAN:
                    return "bool(" + data() + ")";
                case ResourceValue.Type.INT_COLOR_ARGB8:
                    return "argb8(" + dataHexString() + ")";
                case ResourceValue.Type.INT_COLOR_RGB8:
                    return "rgb8(" + dataHexString() + ")";
                case ResourceValue.Type.INT_COLOR_ARGB4:
                    return "argb4(" + dataHexString() + ")";
                case ResourceValue.Type.INT_COLOR_RGB4:
