...
namespace ApkResourceParser
{
    ...
    public class StringPoolChunk : Chunk
    {
        ...
        /// </summary>
        protected internal readonly List<string> strings = new();
        ...
        /// </summary>
        protected internal readonly List<StringPoolStyle> styles = new();
        ...
        /// </summary>
        public record StringPoolStyle(IList<StringPoolSpan> spans)
        {
        ...
        /// </summary>
        public record StringPoolSpan(int nameIndex, int start, int stop, StringPoolChunk parent)
        {
