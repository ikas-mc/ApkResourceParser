...
public record ResourceIdentifier(int packageId, int typeId, int entryId) {
    ...
    /**
     * Returns a {@link ikas.project.java.apk.arsc.ResourceIdentifier} from a {@code resourceId} of the form 0xpptteeee.
     */
    ...
    /**
     * Returns a {@link ikas.project.java.apk.arsc.ResourceIdentifier} with the given identifiers.
     */
